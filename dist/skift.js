...
function initializeFromQueryString(session) {
    var query = querystringify__WEBPACK_IMPORTED_MODULE_5___default.a.parse(location.search);
...
function reloadWithoutAbTestParameter() {
    ...
    location.href =
        location.href.replace(location.search, '').replace(location.hash, '') +
            querystringify__WEBPACK_IMPORTED_MODULE_5___default.a.stringify(query, Object.keys(query).length > 0) +
            location.hash;
}
...
var SplitTest = /** @class */ (function () {
    ...
    SplitTest.prototype.getVariationUrl = function (variationName) {
        ...
        var query = querystringify__WEBPACK_IMPORTED_MODULE_3___default.a.parse(location.search);
        try {
            ...
            return (location.protocol +
                ...
                location.host +
                location.pathname +
                querystringify__WEBPACK_IMPORTED_MODULE_3___default.a.stringify(query, true) +
                location.hash);
        }
        catch (e) {
