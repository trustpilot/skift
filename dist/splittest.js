(function (factory) {
    ...
    (function (TP) {
        ...
        (function (abTest) {
            ...
            (function initialize() {
                ...
                $(() => {
                    if (typeof globalCondition !== "function" || globalCondition(userSession.userAgent)) {
                        ...
                        $(window).on("pagehide", () => {
                            if (abTest.tests.length > 0) {
                                userSession.save(cookieName);
                            }
                        });
                        abTest.tests = abTest.tests.filter((test) => {
            ...
            abTest.getUserAgentInfo = getUserAgentInfo;
            function getTest(name) {
                return abTest.tests.filter(t => t.name === name)[0];
            }
            abTest.getTest = getTest;
            ...
            abTest.hasTestVariant = hasTestVariant;
            ...
            abTest.setTestVariant = setTestVariant;
            ...
            (function (ui) {
                ...
                function show() {
                    ...
                    else if (abTest.tests.length > 0) {
                        showAbTestUi(abTest.tests[0]);
                    }
                }
                ui.show = show;
                function hide() {
                ...
                ui.hide = hide;
            })(ui = abTest.ui || (abTest.ui = {}));
        })(abTest = TP.abTest || (TP.abTest = {}));
    })(TP || (TP = {}));
});
